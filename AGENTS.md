...
| **v2.1 product spec** (grid25 in JSON, tree_apices/terrain_coarse in light GPKG, disk rule, trees v3 follow-up) | `docs/v2.1-product-spec.md` | implementing `product_version 2.1`, heightfield/landcover fast path, `/api/v3/trees` |
