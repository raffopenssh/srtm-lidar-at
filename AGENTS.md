...
| **v2.1 product** (grid25 in JSON, tree_apices/terrain_coarse in light GPKG, disk rule, trees v3 follow-up) | `docs/v2.1-product-spec.md` | touching `v21_products.py`, the `v21` tile-loop / light-GPKG / JSON plumbing, `v2_verify.check_v21_*`, `kg_v2_store.grid25`, `/kg/<code>/heightfield|landcover`, `/api/v3/trees` |
